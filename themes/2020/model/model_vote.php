...
class Admin_Model_Vote extends WP_List_Table {
    ...
    public function __construct($args = array()) {
        $args = array(
            'plural' => 'ID', /* GIA TRI NAY TUONG UNG VOI key TRONG t */
    ...
    private function table_data() {
        ...
        /* HUYEN CAC GIA TRI where KET VOI NHAU BOI and */
        if (count($whereArr) > 0) {
    ...
    public function column_vote_hueizhang($item) {
        echo '<lable><i style ="color: #ff5400"><b>'. $item['vote_hueizhang_permission'].'</b> -- '. $item['vote_hueizhang_agree'] . '</i> -- <i style= "color: #999">' . $item['vote_hueizhang_anti'] . '</i></lable>';
    }

    public function column_vote_jianshi($item) {
        echo '<lable><i style ="color: #ff5400"><b>'. $item['vote_jianshi_permission'].'</b> -- ' . $item['vote_jianshi_agree'] . '</i> -- <i style= "color: #999">' . $item['vote_jianshi_anti'] . '</i></lable>';
    }
    ...
    public function saveItem($imgFile, $arrData = array(),  $option = array()) {
        ...
        $data = array(
            ...
            'img' => $imgFile,
            'kid' => $arrData['sel_kid'],
            'vote_hueizhang_permission' => $arrData['txt_hueizhang_permission'],
            'vote_hueizhang_agree' => $arrData['txt_hueizhang_agree'],
            'vote_hueizhang_anti' => $arrData['txt_hueizhang_anti'],
            'vote_jianshi_permission' => $arrData['txt_jianshi_permission'],
            'vote_jianshi_agree' => $arrData['txt_jianshi_agree'],
            'vote_jianshi_anti' => $arrData['txt_jianshi_anti'],
            /* 'vote_fail' => $arrData['txt_fail'], */
