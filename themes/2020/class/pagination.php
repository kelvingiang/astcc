        ...
        if ($this->_config['total_record'] > $this->_config['limit'])
        {
            ...
            if ($this->_config['current_page'] > 1)
            {
               // $p .= '<li><a href="'.$this->__link('1').'">First</a></li>';
                $p .= '<li><a href="'.$this->__link($this->_config['current_page']-1).'"> <i class="fa fa-angle-double-left"> </i> </a></li>';
            }
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $p .= '<li><a href="'.$this->__link($this->_config['current_page'] + 1).'"> <i class="fa fa-angle-double-right"></i></a></li>';
            }
...
<style>
    .pagin{text-align: center; position: absolute; right: 30px; padding-top: 8px }
