...
if (isset($_FILES['myfile'])) {
    ...
    //$name = $_SESSION['login'];
    $cus_name = $r['barcode'] . '.' . $trim_type;  //tao name moi cho file tranh trung va mat file
    ...
    $path = upload_guests(); // get function path upload img dc khai bao tai file hepler
    ...
    if (empty($errors) == true) {
      ...
      //  $layer->resizeInPixel(250, 250, true); // sau khi tao thanh hinh vuong resize la kinh thuoc minh mong muon
        // phan save hinh 
        $dirPath = upload_guests();
