...
//    wp_register_script('jquery-script', get_template_directory_uri() . '/js/jquery-1.7.2.min.js', array('jquery'));
...
//    moi them cho 29/04 
        ...
        wp_register_script('jquery-skitter', get_template_directory_uri() . '/js/jquery.skitter.js', array('jquery'));
...
//        wp_register_script('ckeditor-script', get_template_directory_uri() . '/lib/class/ckeditor/ckeditor.js', array('jquery'));
//        wp_enqueue_script('ckeditor-script');
//
//        wp_register_script('ckfinder-script', get_template_directory_uri() . '/lib/class/ckfinder/ckfinder.js', array('jquery'));
...
function admin_style() {
    ...
    /* javacript */
//    wp_register_script('jquery-script', get_template_directory_uri() . '/js/jquery-1.11.3.min.js', array('jquery'));
//    wp_enqueue_script('jquery-script');
