...
class Admin_Controler_Advertising {

    public function __construct() {
        add_action('init', array($this, 'register_post'));
        add_action('manage_edit-advertising_columns', array($this, 'manage_cols'));
        add_action('manage_advertising_posts_custom_column', array($this, 'render_cols'));
    }
