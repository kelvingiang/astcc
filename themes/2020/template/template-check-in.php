            ...
            jQuery.ajax({
                ...
                success: function(data) { // set ket qua tra ve  data tra ve co thanh phan status va message
                    ...
                    if (data.status === 'done') {
                        ...
                        jQuery('#guest-main').css('visibility', 'visible');
                        ...
                        jQuery('#last-check-in, #accout-unactive').css('display', 'none');
                        jQuery('#guest-main').css('visibility', 'hidden');
                        jQuery('#barcode-error').css('display', 'block');
                        window.setTimeout(function() {
                            jQuery('.my-waiting').css('display', 'none');
                        }, 100);
                    } else if (data.status === 'unactive') {
                        jQuery('#last-check-in, #barcode-error').css('display', 'none');
                        jQuery('#guest-main').css('visibility', 'hidden');
