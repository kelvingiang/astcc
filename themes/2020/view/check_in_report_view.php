...
<div class="report_head" style="height: 60px; margin-top: 20px">
    ...
    <!--    <a style=' margin-top: 2px; margin-right: 40px; letter-spacing: 4px ' 
           class="button button-primary button-large" 
           href="<?php // echo "admin.php?page=$page&action=export"  
                    ?>"> 導出 excel</a>-->
    <!--    <a style=' margin-top: 2px; margin-right: 40px; letter-spacing: 4px ' 
           class="button button-primary button-large" 
           href="<?php //  echo "admin.php?page=$page&action=barcode"  
                    ?>"> 導出 barcode </a>-->
    <a style=' margin-top: 2px; margin-right: 40px; letter-spacing: 4px ' class="button button-primary button-large" href="<?php echo "admin.php?page=$page&action=waiting" ?>">標題-時區-刷卡</a>

</div>
<div>
    <H2>報 名 總 數 : <?php echo count($registerList) ?></H2>
