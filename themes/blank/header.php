        ...
        <?php if (!is_page('check-in')) { ?>
            <div class="container-fluid" >
                <div id="loggo">
                    ...
                    <div><h1 class="title-cn">亞 洲 台 灣 商 會 聯 合 總 會 </h1>
                        <h1 class="title-en">ASIA TAIWANESE CHAMBERS OF COMMERCE</h1></div>
                </div>
                <div style=" clear: both"></div>
                <div id="header" class="row" style="padding-bottom: 20px;">
                    <!--ham nay dc viet trong file function -->
                    <!--  ADD PHAN SILDER -->
                    <div class="col-md-12 silder-space"><?php get_template_part('template/template', 'silder'); ?></div> 
                    <!--  ham get menu dc viet trong file function -->
                    <div class="col-md-12"><?php suite_menu('primary-menu') ?></div>
                    <div class="col-md-12" >
