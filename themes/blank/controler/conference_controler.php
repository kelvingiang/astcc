...
class Admin_Conference_Controler {

    public function __construct() {
        add_action('init', array($this, 'register_post'));
        add_action('manage_edit-conference_columns', array($this, 'manage_cols'));
        add_action('manage_conference_posts_custom_column', array($this, 'render_cols'));
       ...
       // add_action('init', array($this, 'register_taxonomy'));
        ...
        //==== xap xep ============================================
     //   add_filter('manage_edit-conference_sortable_columns', array($this, 'sortable_views_column'));
...
//    $img = get_post_meta($post->ID, 'm_image', true);
    ...
    public function register_taxonomy() {
        ...
        register_taxonomy('conference_cate', 'conference', array(
            'labels' => $labels,
            'public' => true,
            //'show_ui' => true,
            'show_tagcloud' => true,
    ...
    public function register_tag() {
        ...
        register_taxonomy('conference_tag', 'conference', array(
