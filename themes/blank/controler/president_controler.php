...
class Admin_President_Controler {
    ...
    public function __construct() {
        add_action('init', array($this, 'PresidentCusPost'));
        add_action('manage_edit-president_columns', array($this, 'presidentManage_cols'));
        add_action('manage_president_posts_custom_column', array($this, 'presidentRender_cols'));
    }

    public function PresidentCusPost() {
        $labels = array(
            'name' => _x('會長', 'suite'),
    ...
    public function presidentManage_cols($columns) {
...
// function dua noi dung vao cac cot moi  tạo
    public function presidentRender_cols($columns) {
