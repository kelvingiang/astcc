<div class="row-2">
    <div class="fluid_container">
        <div id="map_canvas" style="position: relative; z-index: 28 ; height: 550px;  width: 100%; margin: 0 auto ;  border-bottom: 3px green solid; border-top: 3px green solid"></div>
    </div>
</div>
