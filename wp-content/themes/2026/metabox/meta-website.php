  ...
  //      echo __METHOD__;
    ...
    //        echo __METHOD__;
        ...
        echo  '<p><label class="title_text" for ="'. $inputID. '">' .  translate('網站地址')  .' <i> 輸入整個網站的地址如 : http://yahoo.com </i> </label>'
                . '<input type="text" name="' . esc_attr($inputName) . '" id="' . esc_attr($inputID) . '" value="' . esc_attr($inputvalue) . '" class="txt_input" size="25" placeholder="http://yourdomain.com" />'
                .'</p>';
